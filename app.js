...
let title_card =document.getElementById('title-card').innerHTML=card_title_value;
let card_desc = document.getElementById('card-paragraph').innerHTML=card_title_value;
...
let killCard = () =>{
    ...
    title_card =document.getElementById('title-card').innerHTML=card_title_value;
    card_desc = document.getElementById('card-paragraph').innerHTML=card_title_value;
}